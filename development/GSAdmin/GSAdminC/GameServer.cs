...
namespace GameServerInfo
{
	...
	public class GameServer
	{
		...
		private int _port, _timeOut = 400;
        ...
        public string spawnprotect
        {
            get
            {
                return _serverInfo.spawnprotect;
            }
        }
